define([
    ...
    return declare([GraphicsLayer], {
        ...
        constructor: function (options) {
            ...
            this._inSpatialReference = new SpatialReference({wkid: 4214});  // Data must be in Geographic Coordinates
            ...
            // Manage drawing
            this._maxDraw = options.maxdraw || 6000;  // default to 1000 graphics
            this._drawCount = 0;
