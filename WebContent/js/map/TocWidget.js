define(["dojo/_base/declare", 
        ...
        "dijit/form/HorizontalSlider"],
         function(declare, array,
				query, domAttr, domStyle, on, lang, CheckBox, _BaseWidget,
			...
			return declare([ _BaseWidget,
				...
				setToc:function(){
					...
					console.log(fileLog + "图层层数:" +this.map.allLayers.length);
	            ...
	            buildLayerList: function (layer) {
	                ...
	                for (var i = 0; i < subLayers.length; i++) {
	                    ...
	                    if (isDynamicLayer === true) {
	                        currentHTML += "<input type='checkbox' class='" + currentLayer.id + "TOC' " + (currentSubLayer.visible ? " CHECKED " : "") + " id='" + currentSubLayer.id + "'/>";
	                    }
	                ...
	                console.log(fileLog + "test2"+isDynamicLayer);
